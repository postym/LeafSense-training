...
[postym/LeafSense_Dataset on Hugging Face](https://huggingface.co/datasets/postym/LeafSense_Dataset)
...
## Results
See training_results.png, confusion_matrix_final*.png, and overall_metrics.png for detailed per-class performance breakdowns.